  ...
  return (
    <div style={{minHeight:"100vh", background:C.bg, color:C.text, fontFamily:"system-ui,sans-serif"}}>
      ...
      <div style={{display:"flex", gap:4, padding:"7px 11px", background:C.card, borderBottom:"1px solid "+C.border, overflowX:"auto", position:"sticky", top:0, zIndex:100}}>
        {[["dashboard","Inicio"],["transacoes","Lancamentos"],["fixos","Fixos"],["investimentos","Investir"],["metas","Metas"],["analise","Analise"]].map(([id,lbl]) => (
          ...
          <div className="up">
            ...
            <Card style={{marginBottom:14}}>
              <div style={{display:"flex", justifyContent:"space-between", marginBottom:10}}>
                ...
                <span style={{fontWeight:700, color:C.purple}}>{fmt(fixos.reduce((s,f) => s+f.value, 0))}</span>
              </div>
              {fixos.length === 0 && (
          ...
          <div className="up">
            ...
            <Card style={{marginBottom:11}}>
              ...
              <div style={{fontSize:30, fontWeight:900, color:C.green}}>
                {fmt(txs.filter(t => t.type==="investimento").reduce((s,t) => s+t.value, 0))}
              </div>
            </Card>
        ...
        <div style={{position:"fixed", inset:0, zIndex:300, display:"flex", flexDirection:"column", background:C.bg}}>
          ...
          <div style={{padding:"8px 12px 0", background:C.card, borderTop:"1px solid "+C.border}}>
            ...
            <div style={{display:"flex", gap:7, paddingBottom:12}}>
              <label htmlFor="cam-inp" style={{background:"#0d1f38", color:C.text, border:"1px solid "+C.border, borderRadius:11, padding:"0 12px", fontSize:18, display:"flex", alignItems:"center", cursor:"pointer", flexShrink:0}}>
                Cam
                <input
                  id="cam-inp"
                  type="file"
              ...
              <label htmlFor="gal-inp" style={{background:"#0d1f38", color:C.text, border:"1px solid "+C.border, borderRadius:11, padding:"0 12px", fontSize:16, display:"flex", alignItems:"center", cursor:"pointer", flexShrink:0}}>
                Gal
                <input
                  id="gal-inp"
                  type="file"
